var perlin = noise.perlin3,
  sounds = {
    bg: new Audio("https://projects.thibautfoussard.com/themountains/music/soundtrack.mp3"),
    transition: new Audio("https://projects.thibautfoussard.com/themountains/music/sonar2.mp3")
  },
  lightPositionAmp = 8,
...
function init() {
  ...
  loader.load("https://projects.thibautfoussard.com/themountains/json/plane%202.json", function(geometry, materials) {
